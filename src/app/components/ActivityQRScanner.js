...
import { validateActivityTicket } from '@/app/actions/activities';
import { CheckCircle2, XCircle, Camera, RefreshCw, User, ClipboardCheck } from 'lucide-react';

export default function ActivityQRScanner({ activityId, activityName }) {
    ...
    async function onScanSuccess(decodedText) {
        ...
        try {
            const result = await validateActivityTicket(activityId, token);
    ...
    return (
        <div className="max-w-2xl mx-auto py-8 px-4">
            ...
            <header className="mb-8 text-center">
                <h2 className="text-2xl font-bold text-slate-900">{activityName} Check-in</h2>
                <p className="text-slate-500 text-sm mt-1">Scan activity QR for access</p>
            </header>
                    ...
                    >
                        {scanResult.loading ? (
                            ...
                            <>
                                ...
                                <h3 className="text-3xl font-black text-white mb-2 uppercase tracking-tight">Checked In!</h3>
                                ...
                                <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 w-full">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="flex items-center justify-center gap-2 text-white/90 font-black text-xs uppercase tracking-widest">
                            ...
                            <>
                                ...
                                <h3 className="text-3xl font-black text-white mb-2">ERROR</h3>
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-slate-900">
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-100 text-center shadow-sm">
                    <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Check-in</div>
