...
export default function ActivityQRBadge({ attendeeName, activityName, activityId, token }) {
    ...
    return (
        <>
            <button 
                ...
                className="bg-indigo-50 text-indigo-600 px-1.5 py-0.5 rounded-md text-[10px] font-bold border border-indigo-100 hover:bg-indigo-100 transition-colors flex items-center justify-center gap-1"
                title="View QR Code"
            >
                ...
                >
                    ...
                    >
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            <div>
                                <h3 className="text-lg font-bold text-slate-900">{attendeeName}</h3>
                                <p className="text-[10px] text-indigo-600 font-bold tracking-widest uppercase">{activityName} • QR</p>
                            </div>
                            <button 
                        ...
                        <div className="p-10 text-center">
                            <div className="inline-block p-6 bg-slate-50 rounded-3xl mb-4 border border-slate-100">
                                <img 
                                    src={`/api/qr/activities/${activityId}/${token}`} 
                                    alt="Check-in QR" 
