...
export default function ParticipantQRScanner() {
    ...
    return (
        <div className="max-w-2xl mx-auto py-8 px-4">
            ...
            <header className="mb-8 text-center">
                <h2 className="text-2xl font-bold text-slate-900">Conference Check-in</h2>
                <p className="text-slate-500 text-sm mt-1">Scan participant QR for registration</p>
            </header>
            ...
            <p className="mt-8 text-center text-[10px] text-slate-400 font-medium px-12 leading-relaxed italic">
                Place the participant QR code inside the frame to scan. Success or failure will flash immediately. No page reload required.
            </p>
        </div>
    );
}
